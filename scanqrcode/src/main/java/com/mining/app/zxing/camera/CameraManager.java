...
public final class CameraManager {
    ...
    private static final float RATE_MAX = 5F;
    private static final float RATE_MIN = 0.8F;

    private static final int MIN_FRAME_WIDTH = 240;
    private static final int MIN_FRAME_HEIGHT = 240;
    @SuppressWarnings("unused")
    private static final int MAX_FRAME_WIDTH = 2480;
    @SuppressWarnings("unused")
    private static final int MAX_FRAME_HEIGHT = 2480;
    ...
    public Rect getFramingRect() {
        ...
        if (framingRect == null && screenResolution != null) {
            ...
            if (x < y) {
                ...
                height = (int) (width / mWHRate);
            } else {
                height = y * 3 / 5;
                if (height < MIN_FRAME_HEIGHT) {
                    height = MIN_FRAME_HEIGHT;
                }
                width = (int) (height * mWHRate);
            }

            int leftOffset = (x - width) / 2;
            int topOffset;
            if (mWHRate < 1) {
                topOffset = (y - height) / 8;
            } else {
                topOffset = (int) ((y - height) * mLocationRate);
            }
